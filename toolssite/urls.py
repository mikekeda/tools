...
from tool.views import tool, worklogs, calendar, dictionary, flashcards, profile_view, update_profile, card_order, log_in, log_out
...
urlpatterns = [
    ...
    url(r'^user/(?P<username>[^/]+)/flashcards$', flashcards, name='flashcards_username'),
    url(r'^ajax/flashcards$', flashcards, name='ajax_flashcards'),
    url(r'^ajax/user/(?P<username>[^/]+)/flashcards$', flashcards, name='ajax_flashcards_username'),
