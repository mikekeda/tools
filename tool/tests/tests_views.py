...
from tool.models import Canvas, Card, Code, Link, Profile, Task, Word, ShoppingList
...
class ToolViewTest(BaseTestCase):
    ...
    def test_views_canvas_tool_list(self):
        ...
        resp = self.client.get(reverse("canvases", kwargs={"username": "testuser"}))
        self.assertEqual(resp.status_code, 200)
    ...
    def test_views_canvas(self):
        ...
        resp = self.client.get(reverse("canvas", kwargs={"slug": test_canvas.slug}))
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(resp.json(), sample_1)

    def test_views_convert_image_tool(self):
        resp = self.client.get(reverse("tool", kwargs={"slug": "image-to-base64"}))
        self.assertEqual(resp.status_code, 200)
    ...
    def test_views_text_tool(self):
        resp = self.client.get(reverse("tool", kwargs={"slug": "text-manipulation"}))
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "text-manipulation.html")

    def test_views_units_converter_tool(self):
        resp = self.client.get(reverse("tool", kwargs={"slug": "units-converter"}))
        self.assertEqual(resp.status_code, 200)
        self.assertTemplateUsed(resp, "units-converter.html")

    def test_views_notexisting_tool(self):
        resp = self.client.get(reverse("tool", kwargs={"slug": "notexisting"}))
    ...
    def test_views_tool_notexisting_user(self):
        resp = self.client.get(
            reverse("user_tool", kwargs={"username": "notexisting", "slug": "text"})
        )
        self.assertEqual(resp.status_code, 404)
        self.assertTemplateUsed(resp, "404.html")
    ...
    def test_views_events(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(str(resp.content, encoding="utf8"), '""')
    ...
    def test_views_calendar_post(self):
        ...
        test_event = Event.objects.get(title="Test title", creator=self.test_user)
        ...
        self.assertRedirects(
            resp, reverse("user_calendar", kwargs={"username": "testuser"})
        )
        test_event_admin = Event.objects.get(
            title="Test title admin", creator=self.test_user
        )
        self.assertEqual(test_event_admin.description, "Test description admin")
    ...
    def test_views_calendar_delete(self):
        ...
        test_event1_exists = Event.objects.filter(pk=test_event1.pk).exists()
        ...
        resp = self.client.delete(
            reverse(
                "user_calendar_pk",
                kwargs={"pk": test_event2.pk, "username": "testuser"},
            )
        )
        self.assertEqual(resp.status_code, 200)
        self.assertJSONEqual(
        ...
        test_event2_exists = Event.objects.filter(pk=test_event2.pk).exists()
    ...
    def test_views_dictionary_put(self):
        ...
        self.assertEqual(resp.status_code, 403)
        self.assertEqual(
            str(resp.content, encoding="utf8"), '"You can\'t change this field"'
        )
    ...
    def test_views_flashcards_post(self):
        ...
        test_flashcard = Card.objects.get(word="Test flashcard", user=self.test_user)
        ...
        self.assertRedirects(
            resp, reverse("user_flashcards", kwargs={"username": "testuser"})
        )
        test_flashcard_admin = Card.objects.get(
            word="Test flashcard admin", user=self.test_user
        )
    ...
    def test_views_flashcards_delete(self):
        ...
        test_flashcard_exists = Card.objects.filter(pk=test_flashcard.pk).exists()
    ...
    def test_views_flashcards_order(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(str(resp.content, encoding="utf8"), '"The order was changed"')
    ...
    def test_views_tasks_post(self):
        ...
        self.assertRedirects(
            resp, reverse("user_tasks", kwargs={"username": "testuser"})
        )
        test_task_admin = Task.objects.get(title="Test task admin", user=self.test_user)
    ...
    def test_views_tasks_delete(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertJSONEqual(
            str(resp.content, encoding="utf8"), {"redirect": "/tasks", "success": True}
        )
        ...
        test_task_admin_exists = Task.objects.filter(pk=test_task_admin.pk).exists()
    ...
    def test_views_tasks_order(self):
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(str(resp.content, encoding="utf8"), '{"task": {}}')
    ...
    def test_views_code_snippets_post(self):
        ...
        test_code_snippet = Code.objects.get(
            title="Test code snippet", user=self.test_user
        )
        self.assertEqual(test_code_snippet.text, "<pre><code>print(1)<code><pre>")
        ...
        self.assertTemplateUsed(resp, "code.html")
        self.assertEqual(resp.status_code, 200)
        resp = self.client.get(reverse("code_slug", kwargs={"slug": "not-exists"}))
        self.assertEqual(resp.status_code, 404)
        ...
        self.assertRedirects(resp, "/code")
        test_code_snippet = Code.objects.get(
            title="Test code snippet 2", user=self.test_user
        )
        self.assertTrue(test_code_snippet)
        self.assertEqual(test_code_snippet.text, "<pre><code>print(2)<code><pre>")
        # Text should not be empty.
        resp = self.client.post(
            reverse("code_slug", kwargs={"slug": test_code_snippet.slug}),
            {
    ...
    def test_views_code_snippets_delete(self):
        test_code_snippet = Code(
            title="test1", text="code block 1", user=self.test_user
        )
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertJSONEqual(
            str(resp.content, encoding="utf8"), {"redirect": "/code", "success": True}
        )
    ...
    def test_views_links_post(self):
        ...
        test_link = Link.objects.get(link="https://google.com", user=self.test_user)
        ...
        self.assertRedirects(resp, "/links")
        test_link = Link.objects.get(link="https://not-exists.com", user=self.test_user)
        ...
        self.assertRedirects(resp, "/links")
        test_link = Link.objects.get(link="https://facebook.com", user=self.test_user)
        ...
        test_link = Link.objects.get(link="https://youtube.com", user=self.test_user)
    ...
    def test_views_links_delete(self):
        ...
        test_link.save()
        self.assertEqual(str(test_link), "testuser: https://google.com")
        ...
        self.assertEqual(str(test_link_admin), "testuser: https://facebook.com")
        ...
        self.assertEqual(resp.status_code, 200)
        self.assertJSONEqual(
            str(resp.content, encoding="utf8"), {"redirect": "/links", "success": True}
        )
        test_link_exists = Link.objects.filter(pk=test_link.pk).exists()
        ...
        test_link_admin_exists = Link.objects.filter(pk=test_link_admin.pk).exists()
    ...
    def test_views_update_profile(self):
        ...
        self.assertEqual(resp.status_code, 403)
        self.assertEqual(str(resp.content, encoding="utf8"), '"This value not allowed"')
